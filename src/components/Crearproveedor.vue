    ...
    <section class="sform">
        <article class="form">
            <div class="divformulario">
                <h2 class="titulof">Crear un Proveedor</h2>
                <form action="#" class="formulario" @submit.prevent="addproveedor">
                    <input type="text" placeholder="Nif proveedor" v-model="proveedor.nif">
                    <input type="text" placeholder="Nombre proveedor" v-model="proveedor.nombre">
